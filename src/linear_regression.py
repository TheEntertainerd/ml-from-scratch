    ...
    def fit_and_animate(self, X: np.ndarray, y: np.ndarray, quality: str = "low_quality", output_dir: str = "") -> None:
        ...
        class LinearRegressionAnimation(mn.Scene):
            def construct(inner_self) -> None:
                ...
                inner_self.play(mn.Write(XT_matrix), mn.Write(XT_label), mn.Write(X_matrix), mn.Write(X_label), mn.Write(mult_sign))
                inner_self.wait(0.5)
                ...
                inner_self.play(
                    mn.FadeOut(XT_matrix), mn.FadeOut(XT_label), mn.FadeOut(X_matrix), mn.FadeOut(X_label), 
                    mn.FadeOut(mult_sign), mn.FadeOut(equals_sign), mn.FadeOut(XTX_label),
                ...
                XTX_inv_matrix = mn.Matrix(np.round(XTX_inv, 2).tolist()).scale(0.5).next_to(inversion_arrow, mn.DOWN, buff=0.5)
                ...
                inner_self.play(
                    mn.FadeOut(XTX_matrix), mn.FadeOut(XTX_label), mn.FadeOut(inversion_arrow), mn.FadeOut(inv_label),
                ...
                inner_self.play(
                    mn.FadeOut(XTX_inv_matrix), mn.FadeOut(inv_label), mn.FadeOut(XT_matrix), mn.FadeOut(XT_label),
                    mn.FadeOut(mult_sign_2), mn.FadeOut(equals_sign_2), mn.FadeOut(step1_label),
                ...
                inner_self.play(
                    mn.FadeOut(step1_matrix), mn.FadeOut(step1_label), mn.FadeOut(y_matrix), mn.FadeOut(y_label),
                    mn.FadeOut(mult_sign_3), mn.FadeOut(equals_sign_3), mn.FadeOut(eq), mn.FadeOut(weights_label),
                ...
                # Create points
                dots = mn.VGroup(*[mn.Dot(axes.c2p(X[i][0], y[i][0]), radius=0.05, color=mn.BLUE) for i in range(len(X))])
                ...
                squared_label = mn.Text(f"Residuals squared = {np.round(ss_res, 2)}", color=mn.RED).scale(0.5).next_to(r2_formula, mn.DOWN, buff=0.3)
                
                inner_self.play(
                    mn.Transform(residuals, squared_residuals),
                    mn.Transform(residuals_label, squared_label)
                )
                inner_self.wait(1.5)
                
                # Step 3: Update formula with SS_res value
                r2_formula_with_ssres = mn.MathTex(
                ...
                totals_label = mn.Text("Total Deviations", color=mn.GREEN).scale(0.5).next_to(r2_formula, mn.DOWN, buff=0.3)
                ...
                totals_squared_label = mn.Text(f"Total Deviations squared = {np.round(ss_tot, 2)}", color=mn.GREEN).scale(0.5).next_to(r2_formula, mn.DOWN, buff=0.3)
